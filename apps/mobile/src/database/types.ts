...
export interface ActivityPoint { id: number; activity_id: number; latitude: number; longitude: number; altitude: number | null; accuracy: number | null; speed: number | null; recorded_at: Date; is_valid: boolean; rejection_reason_id: number | null; segment_index: number; created_at: Date }
